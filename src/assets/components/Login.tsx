...
const usuarios: Usuario[] = [
  ...
  nombre: "Johan Pira",
  clave: "johan2026",
  permisosSecciones: ["IntelicenciaCanales", "Operaciones"],
  permisosGrupo: ["canal-digital","ejecucion-global","ejecucion-distribuidora","ejecucion-aseguradora","revision","comercial"],
  permisosInformes: [
      "digital-global",
      "digital-caribe",
      "digital-efigas",
